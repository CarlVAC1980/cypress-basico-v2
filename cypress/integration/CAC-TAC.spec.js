...
describe('Central de Atendimento ao Cliente TAT', function () {
    ...
    it('exibe mensagem de erro quando o telefone se torna obrigatorio mas não é preenchido antes do envio do formulário', function () {
        cy.get('#firstName').type('Carlos')
        cy.get('#lastName').type('Costa')
        cy.get('#email').type('cavac10@gmail.com')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function () {
        ...
        cy.get('#lastName')
            ...
            .should('have.value', '')
        cy.get('#email')
            .type('cavac10@gmail.com')
            .should('have.value', 'cavac10@gmail.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('1234567890')
    ...
    it('exibe mensagem de erro ao submeter o formulario sem preencher os campos obrigarórios', function () {
        cy.contains('button', 'Enviar').click()
